    ...
    <>
      ...
      >
        <div className="max-w-[1360px] mx-auto px-4 sm:px-6 flex items-center justify-between h-9">
          ...
          {/* Social icons right */}
          <div className="hidden sm:flex items-center gap-4.5 ml-4 shrink-0">
            <a 
              href="https://www.instagram.com/challengers_volleyball_academy" 
              target="_blank" 
              rel="noopener noreferrer" 
              aria-label="Instagram" 
              className="text-white/70 hover:text-[#FFD700] hover:scale-110 transition-all duration-200"
            >
      ...
      >
        <div className="snb__inner">
          ...
          <NavLink
            ...
            aria-label="Challengers Volleyball Academy Home"
          >
